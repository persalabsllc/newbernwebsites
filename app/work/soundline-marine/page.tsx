...
export default function SoundlineMarine() {
  return <main className={`${styles.shell} ${styles.marine}`}>
    ...
    <section className={styles.section} id="services"><div className={styles.sectionHead}><p className={styles.eyebrow}>CAPABILITIES</p><h2>Waterfront work without shortcuts.</h2><p>Residential and commercial marine construction planned for long service life, clean execution, and the realities of working on the Carolina coast.</p></div><div className={styles.cards}>
      <article className={styles.card}><div className={styles.cardImage} style={{backgroundImage:'url(https://unsplash.com/photos/FDxDyvY-jQE/download?force=true&w=1200)'}}/><div className={styles.cardBody}><h3>Docks & Piers</h3><p>Fixed and floating systems designed around your shoreline, vessel, and water depth.</p></div></article>
      <article className={styles.card}><div className={styles.cardImage} style={{backgroundImage:'url(https://unsplash.com/photos/KcbA6JLCqLg/download?force=true&w=1200)'}}/><div className={styles.cardBody}><h3>Boat Lifts</h3><p>Dependable lift installation, electrical coordination, service, and replacement.</p></div></article>
      <article className={styles.card}><div className={styles.cardImage} style={{backgroundImage:'url(https://unsplash.com/photos/CmYVdPkw09E/download?force=true&w=1200)'}}/><div className={styles.cardBody}><h3>Bulkheads</h3><p>Shoreline stabilization and retaining systems built for your site conditions.</p></div></article>
    </div></section>
    <section className={styles.split} id="projects"><div className={styles.splitCopy}><p className={styles.eyebrow}>FROM PERMITS TO PUNCH LIST</p><h2>One accountable marine contractor.</h2><p>Our team handles site evaluation, design coordination, permitting, mobilization, construction, and final inspection. The result is a cleaner jobsite and a project that keeps moving.</p><ul className={styles.list}><li>Residential docks and boathouses</li><li>Commercial marina improvements</li><li>Wave and shoreline protection</li><li>Repairs, inspections, and storm recovery</li></ul></div><div className={styles.splitImage} style={{backgroundImage:'url(https://unsplash.com/photos/lHz9PksYL5E/download?force=true&w=1400)'}}/></section>
